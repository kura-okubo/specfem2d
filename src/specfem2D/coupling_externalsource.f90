...
!*************************************************************
! Coupling with external source
! 11/02/2019 Kurama Okubo
! This module is developped to coupling with external source in the form of accerelation time series.
!*************************************************************
